---
layout: google_post
title: "Today's 20 Tech Tweaks: Android, AI, & Privacy's Got You Covered"
...
Google's Gemini API on Vertex AI now lets developers peek under the hood, revealing the model's decision-making process via logprobs—no more black box mysteries!  This transparency is a game-changer for building trustworthy and explainable AI applications, giving businesses a crucial edge in understanding and improving their AI-powered products.  Finally, you can see *why* Gemini chose that word, not just *that* it chose it – a huge win for developers and businesses alike. [Read more →](https://developers.googleblog.com/en/unlock-gemini-reasoning-with-logprobs-on-vertex-ai/)
