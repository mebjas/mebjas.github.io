---
layout: google_post
title: "Today's 20 Tech Tweaks: Android, AI, & Gemini Get a Glow-Up"
...
Google's Gemini 2.5 now lets you segment images conversationally—think asking it to precisely outline your cat in a photo, not just draw a box around it.  This leap in AI image understanding makes editing photos and isolating objects a breeze, saving you time and effort compared to fiddling with manual selection tools.  For developers, this opens doors to more intuitive and powerful image manipulation capabilities in their apps. [Read more →](https://developers.googleblog.com/en/conversational-image-segmentation-gemini-2-5/)
