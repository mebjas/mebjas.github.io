...
description: "Your daily dose of tech news is here!  Today's roundup covers a whirlwind of updates: 28 uncategorized gems, 15 focusing on Google AI, plus a sprinkle of Android and Gemini news.  Get your daily fix of digital deliciousness!"
post-no: 11
toc: true
...
Google's Gemini-embedding-001, a top performer on the MTEB Multilingual leaderboard, is now generally available via the Gemini API and Vertex AI.  This means developers can finally unleash the power of its robust text embeddings—presumably without needing to sacrifice their firstborn child to appease the benchmarking gods.  Get ready to build some seriously clever applications! [Read more →](https://developers.googleblog.com/en/gemini-embedding-available-gemini-api/)
