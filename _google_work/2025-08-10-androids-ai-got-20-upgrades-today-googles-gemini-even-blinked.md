---
layout: google_post
title: "Android's AI Got 20 Upgrades Today:  (Google's Gemini even blinked!)"
...
Technology continues to evolve at a rapid pace, and 10/08/2025 brings us 20 significant updates across multiple domains. Today's roundup covers developments in General Google AI, Android + Artificial Intelligence, Android + Gemini and more, showcasing the breadth of innovation happening across the tech landscape. From AI advancements to developer tools, these updates highlight how technology companies are pushing boundaries and creating new possibilities for users and developers alike.
...
Google's finally let us peek under the hood of Gemini on Vertex AI!  The new logprobs feature gives developers access to the model's reasoning, so we can finally stop guessing why Gemini chose "cat" instead of "dog" (it's probably because of the superior cuteness of cats, obviously).  No more black-box AI mysteries; now we can debug those model outputs with the glorious insight of log probabilities. [Read more →](https://developers.googleblog.com/en/unlock-gemini-reasoning-with-logprobs-on-vertex-ai/)
